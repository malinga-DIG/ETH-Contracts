    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        _setupRole(CEO, _safe);
        _setupRole(CFO, _safe);
        _setupRole(CTO, _safe);
    }
    ...
    function BlacklistAddress(address actor) public validate {
        Blacklist[actor] = true;
        emit BlackListed(actor, true);
    }

    function UnBlacklistAddress(address actor) public validate {
